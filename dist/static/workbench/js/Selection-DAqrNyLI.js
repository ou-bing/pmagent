...
`,[B("strong",`
 ...
 `,[G("disabled",[N("&:hover","background-color: var(--n-color-checked-hover);"),N("&:active","background-color: var(--n-color-checked-pressed);")])])])]),An=Object.assign(Object.assign(Object.assign({},V.props),On),{bordered:{type:Boolean,default:void 0},checked:Boolean,checkable:Boolean,strong:Boolean,triggerClickOnClose:Boolean,onClose:[Array,Function],onMouseenter:Function,onMouseleave:Function,"onUpdate:checked":Function,onUpdateChecked:Function,internalCloseFocusable:{type:Boolean,default:!0},internalCloseIsButtonTag:{type:Boolean,default:!0},onCheckedChange:Function}),Fn=jt("n-tag"),xe=Z({name:"Tag",props:An,slots:Object,setup(e){const n=A(null),{mergedBorderedRef:t,mergedClsPrefixRef:o,inlineThemeDisabled:a,mergedRtlRef:f}=Pe(e),l=V("Tag","-tag",Tn,Dt,e,o);Yt(Fn,{roundRef:ne(e,"round")});function r(){if(!e.disabled&&e.checkable){const{checked:m,onCheckedChange:g,onUpdateChecked:y,"onUpdate:checked":k}=e;y&&y(!m),k&&k(!m),g&&g(!m)}}function p(m){if(e.triggerClickOnClose||m.stopPropagation(),!e.disabled){const{onClose:g}=e;g&&Ht(g,m)}}const d={setTextContent(m){const{value:g}=n;g&&(g.textContent=m)}},c=Le("Tag",f,o),s=L(()=>{const{type:m,size:g,color:{color:y,textColor:k}={}}=e,{common:{cubicBezierEaseInOut:P},self:{padding:R,closeMargin:w,borderRadius:u,opacityDisabled:b,textColorCheckable:z,textColorHoverCheckable:I,textColorPressedCheckable:E,textColorChecked:_,colorCheckable:S,colorHoverCheckable:K,colorPressedCheckable:D,colorChecked:T,colorCheckedHover:re,colorCheckedPressed:ie,closeBorderRadius:le,fontWeightStrong:ae,[F("colorBordered",m)]:se,[F("closeSize",g)]:ce,[F("closeIconSize",g)]:q,[F("fontSize",g)]:W,[F("height",g)]:Y,[F("color",m)]:U,[F("textColor",m)]:de,[F("border",m)]:ue,[F("closeIconColor",m)]:J,[F("closeIconColorHover",m)]:he,[F("closeIconColorPressed",m)]:fe,[F("closeColorHover",m)]:ve,[F("closeColorPressed",m)]:be}}=l.value,H=ke(w);return{"--n-font-weight-strong":ae,"--n-avatar-size-override":`calc(${Y} - 8px)`,"--n-bezier":P,"--n-border-radius":u,"--n-border":ue,"--n-close-icon-size":q,"--n-close-color-pressed":be,"--n-close-color-hover":ve,"--n-close-border-radius":le,"--n-close-icon-color":J,"--n-close-icon-color-hover":he,"--n-close-icon-color-pressed":fe,"--n-close-icon-color-disabled":J,"--n-close-margin-top":H.top,"--n-close-margin-right":H.right,"--n-close-margin-bottom":H.bottom,"--n-close-margin-left":H.left,"--n-close-size":ce,"--n-color":y||(t.value?se:U),"--n-color-checkable":S,"--n-color-checked":T,"--n-color-checked-hover":re,"--n-color-checked-pressed":ie,"--n-color-hover-checkable":K,"--n-color-pressed-checkable":D,"--n-font-size":W,"--n-height":Y,"--n-opacity-disabled":b,"--n-padding":R,"--n-text-color":k||de,"--n-text-color-checkable":z,"--n-text-color-checked":_,"--n-text-color-hover-checkable":I,"--n-text-color-pressed-checkable":E}}),C=a?Se("tag",L(()=>{let m="";const{type:g,size:y,color:{color:k,textColor:P}={}}=e;return m+=g[0],m+=y[0],k&&(m+=`a${Oe(k)}`),P&&(m+=`b${Oe(P)}`),t.value&&(m+="c"),m}),s,e):void 0;return Object.assign(Object.assign({},d),{rtlEnabled:c,mergedClsPrefix:o,contentRef:n,mergedBordered:t,handleClick:r,handleCloseClick:p,cssVars:a?void 0:s,themeClass:C==null?void 0:C.themeClass,onRender:C==null?void 0:C.onRender})},render(){var e,n;const{mergedClsPrefix:t,rtlEnabled:o,closable:a,color:{borderColor:f}={},round:l,onRender:r,$slots:p}=this;r==null||r();const d=_e(p.avatar,s=>s&&v("div",{class:`${t}-tag__avatar`},s)),c=_e(p.icon,s=>s&&v("div",{class:`${t}-tag__icon`},s));return v("div",{class:[`${t}-tag`,this.themeClass,{[`${t}-tag--rtl`]:o,[`${t}-tag--strong`]:this.strong,[`${t}-tag--disabled`]:this.disabled,[`${t}-tag--checkable`]:this.checkable,[`${t}-tag--checked`]:this.checkable&&this.checked,[`${t}-tag--round`]:l,[`${t}-tag--avatar`]:d,[`${t}-tag--icon`]:c,[`${t}-tag--closable`]:a}],style:this.cssVars,onClick:this.handleClick,onMouseenter:this.onMouseenter,onMouseleave:this.onMouseleave},c||d,v("span",{class:`${t}-tag__content`,ref:"contentRef"},(n=(e=this.$slots).default)===null||n===void 0?void 0:n.call(e)),!this.checkable&&a?v(Wt,{clsPrefix:t,class:`${t}-tag__close`,disabled:this.disabled,onClick:this.handleCloseClick,focusable:this.internalCloseFocusable,round:l,isButtonTag:this.internalCloseIsButtonTag,absolute:!0}):null,!this.checkable&&this.mergedBordered?v("div",{class:`${t}-tag__border`,style:{borderColor:f}}):null)}}),Bn=N([$("base-selection",`
